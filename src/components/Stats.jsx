    ...
    <>
      ...
      <div className="stats-grid">
        ...
        <StatCard title="Avg # of Coffees">
         ...
         <StatCard title="Daily cost (RON)">
          <p><span className="stat-text">{stats.daily_cost}</span> RON</p>
         </StatCard>
        <StatCard title="Total cost (RON)">
          <p><span className="stat-text">{stats.total_cost}</span> RON</p>
          </StatCard>
<table className="stat-table"><thead>
  <tr>
    <th>Coffee Name</th>
...
<tbody>
  {getTopThreeCoffees(globalData).map((coffee,coffeeIndex) =>{return (
    <tr key={coffeeIndex}>
